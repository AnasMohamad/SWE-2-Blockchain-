...
import com.google.gson.GsonBuilder; 
   ...
   class Peer2Peer {
	   ...
	   public void connect() throws UnknownHostException, SocketException 
	   {
			   ...
			   this.ip = InetAddress.getByName("127.0.0.0");
	   ...
	   public void send(String str , InetAddress ip , int port) throws IOException
	   {
		   String s = this.person.id + " " +  str;
		   DatagramPacket Packet = new DatagramPacket(s.getBytes() , s.length() , ip , port);
		   DS.send(Packet);
		   System.out.println(str + "  ==> sent by:  "+ this.person.id);
